...
('comrcl_user', 'xyz', 1, 30, 'N', 'P4', 0, 'kortex_nga_aws.global.l2', 'Non-Production_Kortex_AWS_Alerts@kellogg.com', '', 'preproc', 'Y', 'Y', 'Snowflake', 'keu_it_small', '', 'N');
...
('comrcl_user', 'comrcl_user', 'xyz', 'abc', 'abc', 'confd', 0, 'csv', ',', '', 'okrdra', 'Y', 1, 'N', '', '', '', '', 'load', 'Y', '', 'N', '', '', '', '', '');
...
('comrcl_user', 'abc', 'Model', 1, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Select Version', 2, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Report_Count', 3, 'NUMBER(38,0)', 2, 2, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Comparison Version', 4, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Report_Date', 5, 'TIMESTAMP_NTZ', 19, 19, 'X', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Select Version Code', 6, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'FX Version Code', 7, 'VARCHAR(255)', 22, 22, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Comparison Version Code', 8, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Type of Version', 9, 'VARCHAR(255)', 15, 15, '', '', '', '', '', '', '', '', '', '', ''),
('comrcl_user', 'abc', 'Flag', 10, 'VARCHAR(255)', 5, 5, '', '', '', '', '', '', '', '', '', '', '');