...
('fin_user', 'fin_user', 'X', 'X', 'X', 'confd', 0, 'csv', ',', '', 'okrdra', 'Y', 1, 'N', '', '', '', '', 'load', 'Y', '', 'N', '', '', '', '', '');
...
('fin_user', 'X', 'Model', 1, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Select Version', 2, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Report_Count', 3, 'NUMBER(38,0)', 2, 2, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Comparison Version', 4, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Report_Date', 5, 'TIMESTAMP_NTZ', 19, 19, 'X', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Select Version Code', 6, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'FX Version Code', 7, 'VARCHAR(255)', 22, 22, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Comparison Version Code', 8, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Type of Version', 9, 'VARCHAR(255)', 15, 15, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'X', 'Flag', 10, 'VARCHAR(255)', 5, 5, '', '', '', '', '', '', '', '', '', '', '');