...
('fin_user', '', '1', '30', 'N', 'P4', '0', 'kortex_nga_aws.global.l2', 'Non-Production_Kortex_AWS_Alerts@kellogg.com', '', 'preproc', 'Y', 'Snowflake', 'keu_it_small', '', 'N', 'N');
...
('fin_user', 'fin_user', '', '', '', 'confd', '0', 'csv', '', '', 'okrdra', 'Y', '1', 'N', '', '', '', '', 'load', 'Y', '', 'N', '', '', '', '', '');
