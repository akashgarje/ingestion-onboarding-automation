...
('fin_user', 'fin_cnt', 1, 30, 'N', 'P4', 0, 'kortex_nga_aws.global.l2', 'Non-Production_Kortex_AWS_Alerts@kellogg.com', '', 'preproc', 'Y', 'Y', 'Snowflake', 'keu_it_small', '', 'N');
...
('fin_user', 'keu_bw', 'fin_cnt', 'ver_cntl', 'ver_cntl', 'intrnl', 0, 'excel', ',', '', 'okkkra', 'Y', 1, 'N', '', '', '', '', 'load', 'Y', '', 'N', '', '', '', '', '');
...
('fin_user', 'ver_cntl', 'Model', 1, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Select Version', 2, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Report_Count', 3, 'NUMBER(38,0)', 2, 2, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Comparison Version', 4, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Report_Date', 5, 'TIMESTAMP_NTZ', 19, 19, 'X', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Select Version Code', 6, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'FX Version Code', 7, 'VARCHAR(255)', 22, 22, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Comparison Version Code', 8, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Type of Version', 9, 'VARCHAR(255)', 15, 15, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'ver_cntl', 'Flag', 10, 'VARCHAR(255)', 5, 5, '', '', '', '', '', '', '', '', '', '', '');