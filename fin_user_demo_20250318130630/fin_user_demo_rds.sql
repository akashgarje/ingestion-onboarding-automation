...
('fin_user', 'demo', 1, 30, 'N', 'P4', 0, 'kortex_nga_aws.global.l2', 'Non-Production_Kortex_AWS_Alerts@kellogg.com', '', 'preproc', 'Y', 'Y', 'Snowflake', 'keu_it_small', '', 'N');
...
('fin_user', 'fin_user', 'demo', 'demo_1', 'demo_1', 'confd', 0, 'csv', ',', '', 'okrdra', 'Y', 1, 'N', '', '', '', '', 'load', 'Y', '', 'N', '', '', '', '', '');
