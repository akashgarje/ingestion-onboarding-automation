...
('fin_user', 'test_1', '1', '30', 'N', 'P4', '0', 'kortex_nga_aws.global.l2', 'Non-Production_Kortex_AWS_Alerts@kellogg.com', '', 'preproc', 'Y', 'Redshift', 'keu_it_small', '', 'N', 'N');
...
INSERT INTO app_mgmt.sys_config_table_info (src_nm, domn_nm, dataset_nm, redshift_table_nm, src_table_nm, data_clasfctn_nm, file_qty, fmt_type_cd, delmtr_cd, file_patrn_txt, dprct_methd_cd, load_enbl_flg, file_hdr_cnt, pre_proc_flg, pre_proc_cd, src_encod_cd, src_chrset_cd, src_newln_chr_cd, proc_stage_cd, catlg_flg, dprct_selct_critra_txt, bypas_file_order_seq_check_ind, land_spctrm_flg, wrkflw_nm, copy_by_field_nm_not_posn_index, bypas_file_hdr_config_posn_check_ind, bypas_file_hdr_config_check_inf) VALUES
('fin_user', 'fin_user', 'test_1', 'demo_1', 'demo_1', 'confd', '0', 'csv', ',', '', 'okrdra', 'Y', '1', 'N', '', '', '', '', 'load', 'Y', '', 'N', '', '', '', '', '');
...
('fin_user', 'demo_1', 'Model', 1, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Select Version', 2, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Report_Count', 3, 'NUMBER(38,0)', 2, 2, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Comparison Version', 4, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Report_Date', 5, 'TIMESTAMP_NTZ', 19, 19, 'X', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Select Version Code', 6, 'VARCHAR(255)', 10, 10, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'FX Version Code', 7, 'VARCHAR(255)', 22, 22, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Comparison Version Code', 8, 'VARCHAR(255)', 9, 9, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Type of Version', 9, 'VARCHAR(255)', 15, 15, '', '', '', '', '', '', '', '', '', '', ''),
('fin_user', 'demo_1', 'Flag', 10, 'VARCHAR(255)', 5, 5, '', '', '', '', '', '', '', '', '', '', '');